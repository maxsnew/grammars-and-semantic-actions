...
--     Opening Done Closing Multiplying : AutomatonState
...
--     doneO unexpectedO : b Eq.≡ false → AutomatonTag b n Opening
--     lookaheadRP lookaheadNot : AutomatonTag b n Done
--     closeGood : ∀ {n-1} → n Eq.≡ suc n-1 → AutomatonTag b n Closing
--     closeBad : n Eq.≡ 0 → AutomatonTag b n Closing
--     doneC unexpectedC : b Eq.≡ false → AutomatonTag b n Closing
--     doneGood : n Eq.≡ 0 → b Eq.≡ true → AutomatonTag b n Multiplying
--     add : ∀ {n-1} → n Eq.≡ suc n-1 → AutomatonTag b n Multiplying
--     doneBad unexpectedM : b Eq.≡ false → AutomatonTag b n Multiplying

--   AutomatonTy : Bool → ℕ → AutomatonState → Functor AutomatonState
...
--         (doneO Eq.refl) → {!!}
--         (unexpectedO Eq.refl) → {!!}
--   AutomatonTy b n Done =
--     ⊕e (AutomatonTag b n Done)
--       λ where
--         lookaheadRP → {!!}
--         lookaheadNot → {!!}
