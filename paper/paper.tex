...
\theoryabbv is the first mechanization designed for formal language parsing.

\steven{Contrast their interpretation of dependent types with ours. How tf do I
  say idk what they're doing. Perhaps just say that their dependent types take
  on a different interpreation and no more.}
Luo \cite{luo} describes a Lambek calculus with dependent types.
