...
numbers. 
Next, we include standard $\Sigma,\Pi$, empty, unit, Boolean, and natural number types.
...
\begin{figure}
  ...
  \footnotesize
    ...
    \inferrule{\ctxwffjdg {\Gamma , b : Bool} {X(b)}}
      {\nonlinterm
        {\Gamma, x_0 : X(false), x_1 : X(true), b : Bool}
        {if\,b\,then\,x_0\,else\,x_1}
        {X(b)}
      }
...
\begin{figure}
  ...
  \inferrule{\ctxwffjdg {\Gamma , b : Bool} {X(b)}}
        {\nonlineq
        {\Gamma, x_0 : X(false), x_1 : X(true)}
        {if\,false\,then\,x_0\,else\,x_1}
        {x_0}
        {X(false)}
      }
