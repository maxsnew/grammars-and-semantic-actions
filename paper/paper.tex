...
\begin{figure}
  ...
  \footnotesize
    ...
    \inferrule{\ctxwffjdg \Gamma X}{\ctxwffjdg \Gamma {\listTy{X}}}
...
\begin{figure}
  ...
  \footnotesize
    ...
    \inferrule{~}{\nonlinterm \Gamma {nil} {\listTy{X}}}

    \inferrule
    { \nonlinterm \Gamma {x} {X}
      \and
      \nonlinterm \Gamma {M} {\listTy{X}}}
    {\nonlinterm \Gamma {cons(x,M)} {\listTy{X}}}

    \inferrule
    {
      \ctxwffjdg {\Gamma, xs : \listTy{X}} {Y(xs)} \and
      \nonlinterm {\Gamma} {M} {Y (nil)} \and
      \nonlinterm {\Gamma} {N}
      {\PiTyLimit {x} {X}
        {\PiTyLimit {xs} {\listTy{X}}
          {\PiTyLimit {ys} {Y(xs)} {Y(cons(x,xs))}}}}
    }
    {
      \nonlinterm
      {\Gamma, xs : \listTy{X}}
