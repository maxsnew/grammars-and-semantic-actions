...
\pedro{Should we reference again figure 2 (the inductive type definition of the Kleene star)?}
...
s. s$, \pedro{overloaded notation: $\top$ and type and $\top$ as term}
...
saw one particular NFA corresponding \pedro{trailing sentence?} and its type of traces. More
...
\steven{Add definitions of kleene,lambek,and chomsky categories here?}
...
\steven{Add the arithmetic expression automaton}
