...
\steven{,just take Booleans to be implemented via $1$ and $\Sigma$,} unit, and empty types, and we assume function
extensionality\cite{Hofmann_1997}. We present a selection of
...
regular expressions up to weak equivalence \cite{frischCardelli}. \steven{They
...
\end{theorem}
\begin{proof}
  Because $\semgg{\top}\gamma\,w$ is a singleton set, it suffices to show that
