...
\begin{theorem}[Adamek]
  If a functor $F : \mathcal C \to \mathcal C$ preserves all 
  $\kappa$-colimits and $\mathcal C$ has an initial object and
  $\kappa$-colimits, then $F$ has an initial algebra given by the
