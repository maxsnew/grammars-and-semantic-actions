...
appears in our current Agda implementation \cite{?}. $h'$ is written as a
composition of combinators,
each without any pattern matching or introduction
of named linear variables. More discussion of our implementation is given in \cref{subsec:impl}.
