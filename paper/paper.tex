...
I$. V\'ak\'ar develops a dependent linear type theory where instead the non-linear
types are accessed using the $!$ modality, similar to Girard's original approach
\cite{vakar,girard_linear_1987}. Additionally, V\'ak\'ar develops a general
...
\pedro{I think that it's fine not to include these details}
