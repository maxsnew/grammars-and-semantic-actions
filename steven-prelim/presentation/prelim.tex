...
\begin{frame}{Validation of the CompCert Parser}
  ...
  \onslide<+->{
  Unclear what we do if the Menhir output is incorrect
  \begin{itemize}
    \item<+-> I want a verified parser generator
    \item<+-> I want a more general approach too
  \end{itemize}
  }
  \todoin{this slide is also shit}
\end{frame}
...
\begin{frame}{A Nondeterministic Finite Automaton}
...
\begin{frame}{Separation Logic and Linear Logic Influence}
  ...
  \onslide<3->{Ordered, linear type theory}
  \begin{itemize}
...
\section{Building a Parser Term}
...
\begin{frame}{A Regular Expression Parser}
  ...
  \onslide<2->{
  \begin{block}{Determinization (WIP)}
