...
module String.Base (Alphabet : Alphabet) where
...
-- module _ where
--   @0 DiscreteAlphabet : Discrete ⟨ Alphabet ⟩
--   DiscreteAlphabet = isFinSet→Discrete {!!}
--   -- DiscreteAlphabet c c' = {!!}

--   -- @0 DiscreteString : Discrete String
