...
module Erased.Data.Bool.Properties where
...
open import Erased.Data.Sum.Base hiding (elim)
open import Erased.Data.Bool.Base
open import Erased.Data.Empty as Empty hiding (elim)
open import Erased.Data.Sigma.Base
open import Erased.Data.Unit using (Unit; isPropUnit)
...
@0 notnot : ∀ x → not (not x) ≡ x
notnot true  = refl
notnot false = refl

@0 notIso : Iso Bool Bool
Iso.fun notIso = not
Iso.inv notIso = not
Iso.rightInv notIso = notnot
Iso.leftInv notIso = notnot

@0 notIsEquiv : isEquiv not
notIsEquiv = involIsEquiv {f = not} notnot

@0 notEquiv : Bool ≃ Bool
