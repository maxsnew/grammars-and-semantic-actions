...
module @0 Grammar.Literal.AsPath.Properties (Alphabet : Type ℓ-zero) (@0 isSetAlphabet : isSet Alphabet) where
...
open import Grammar.String.AsPath.Base Alphabet isSetAlphabet
