...
module Grammar.Equalizer.AsEquality.Base (Alphabet : Type ℓ-zero) (@0 isSetAlphabet : isSet Alphabet) where
...
open import Grammar.Inductive.Indexed Alphabet isSetAlphabet hiding (k)
