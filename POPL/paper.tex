...
\newcommand{\theoryabbv}{GTT\xspace}
...
Through the approach described by Krishaswami et al.\ in
...
to be linear unit, characters, $\otimes$, $\oplus$, and arbitrary recursion.
...
\steven{Give this subtheory a name }
