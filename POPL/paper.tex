...
especially.
%
\steven{Some ideas on what the unifying message throughout the paper should be:
we offer an abstraction over the formalisms used ad-hoc when doing formal
language/grammar theory. Whether a user of these constructs recognizes it or not, there is some
universality between all of their systems. We don't necessarily do much, per se, other
than abstract over the commonalities and provide a common language.

However, just because there isn't a ton of clever work in designing this syntax, as
a lot of it does flow very naturally from the literature, that doesn't diminish
the value of the syntax. In fact, it emboldens the syntax because we want to
appeal to the idea that ``there couldn't have been any other choice for
universal grammar''.

That is all to say, our appeal is generalization. I think does appear
throughout the paper, but is maybe too aimless of a message to be satisfying.
Perhaps, we should also lean on applications more. Idk I'm gonna sleep now, and
...
%% developments: 
In this paper, we propose a structured generalization of the
...
A recognizer should be extensionally equivalent to the indicator function
...
\section{Abstracting Formal Grammars}
