...
\steven{No changes pasted from LICS draft}
\steven{Are these now ``Chomsky categories''? or is that disinct?}
...
\steven{Everything below still needs to be edited from my prelim paper}
\steven{Need to grab the canonicity proof from the LICS draft}
