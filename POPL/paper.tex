...
depend on the non-linear types but not vice-versa \cite{dep-lnl}.\max{had to stop here to take care of baby}
...
\steven{Added the above transition paragraph to handle putting the categorical semantics after
