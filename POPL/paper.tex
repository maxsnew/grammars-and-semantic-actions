...
The structrual judgements are shown in \Cref{fig:structjdg}, the typing well-formedness in \Cref{fig:typewf}, and the intuitionistic typing rules in \Cref{fig:inttyping}. There are all just as they appear in \cite{krishnaswami_integrating_2015}.

Our contribution is the addition of base types drawn from the alphabet $\Sigma$ along with the omission of the exchange rule for linear typing judgements.
