...
to ensure that every value in context exactly once. This control enables
...
$\Gamma$ reprsents a non-linear context, while $\Delta$ represents a
...
semantics, we simultaneously give the interpreation $\sem \cdot$ of the
...
if it simlutaneously matches each of $A$ and $B$.
