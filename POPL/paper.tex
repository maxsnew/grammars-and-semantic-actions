...
cumbersome and unintuitive for users who are unacustomed to the usage
restrictions.\max{You are arguing against our own type theory here...} \steven{I
  ...
  convience of LNL, but perhaps this isn't appropriate here, and I don't want to
...
\steven{I am in favor of cutting what's above, but we haven't introduced the
  sytnax in the main body of the paper yet, even if the figures appeared
...
Cardelli, Leiss had added the full power of inductive types to a type system of regular expressions.
...
\steven{Mention Neel's typed algebraic approch paper here. Say it is similar at
...
\steven{Can we sketch here what an apt categorification of KATs might be? As a
  ...
  subcategory that corresponds to the Boolean aglebra?.}
...
Backtracking parsing via delimited continuations?
